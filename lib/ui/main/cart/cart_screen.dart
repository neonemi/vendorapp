                      ...
                      // no need to initialize Controller ever again, just mention the type
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              cartList.where((o) => o.id == cartList[index].id).toList();
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                        alignment: Alignment.topLeft,
                                        child: Text(cartList[index].name!,style: TextStyle(
                                                ...
                                                onTap: () {
                                                  if (cartData != null) {
                                                    ...
                                                    cartController.addProductToCart(
                                                        ...
                                                        orderId: cartList[index].id!,
                                                        unitPrice: cartList[index].price!,
                                                        price: cartList[index].price!,
                                                        quantity: 1,
                                                        productId: cartList[index].id!,
                                                        nameProduct: cartList[index].name!,
                                                        imageProduct: cartList[index].image!);
                                                    preference();
                                                  }
                                                },
                                                child:  Container(
